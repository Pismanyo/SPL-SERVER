...
public interface Server<T> extends Closeable {
    ...
    public static <T> Server<T>  threadPerClient(
            ...
            Supplier<MessageEncoderDecoder<T> > encoderDecoderFactory,StompMessagingProtocol stomp) {

        return new BaseServer<T>(port, protocolFactory, encoderDecoderFactory,stomp) {
            @Override
    ...
    public static <T> Server<T> reactor(
        ...
        return new Reactor<T>(nthreads, port, protocolFactory, encoderDecoderFactory,stomp);
    }
